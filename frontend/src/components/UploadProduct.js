...
const handleSubmit = async(e)=>{
  ...
  return (
    <div className='fixed w-full h-full bg-slate-900/40 right-0 left-0 top-0 bottom-0 flex justify-center items-center p-3 sm:p-4 z-50'>
            ...
            <form className='grid p-1 sm:p-4 gap-2 overflow-y-auto h-full pb-5 'onSubmit={handleSubmit}>
                ...
                />
                 ...
                 ></textarea>
                    ...
                    <button  className=' py-3 px-1 bg-red-600 text-white mb-10 hover:bg-red-700'>upload image</button>
